...
const api: TermpolisAPI = {
  ...
  readWorkflow: (cwd, id, scope) => ipcRenderer.invoke('workflow:read', { cwd, id, scope }),
  saveWorkflow: (cwd, workflow, fromScope) => ipcRenderer.invoke('workflow:save', { cwd, workflow, fromScope }),
  deleteWorkflow: (cwd, id, scope) => ipcRenderer.invoke('workflow:delete', { cwd, id, scope }),
  runWorkflow: (cwd, id, scope, inputs) => ipcRenderer.invoke('workflow:run', { cwd, id, scope, inputs }),
