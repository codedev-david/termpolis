        ...
        <div className="flex-1 overflow-y-auto px-6 py-4 flex flex-col gap-5 text-sm text-[#d4d4d4]">
          ...
          <section>
            ...
            <ul className="flex flex-col gap-1 text-[#bbb] leading-relaxed text-xs">
              ...
              <li><kbd className="bg-[#3c3c3c] px-1 rounded">Ctrl+Shift+X</kbd> Clear terminal — screen <em>and</em> scrollback (the agent keeps its own context) &nbsp;·&nbsp; <kbd className="bg-[#3c3c3c] px-1 rounded">Ctrl+Shift+O</kbd> App log — what Termpolis itself has been printing</li>
